...
import iconBg from "../assets/IThreeM.png";
  ...
  return (
    <footer className="relative h-auto flex flex-col items-center justify-center bg-i3m-dark text-center text-white px-4 py-10">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl w-full">
        {/* Socials Grid */}
        <div>
          <h2 className="text-3xl font-bold sm:text-4xl text-i3m-main mb-4">Join Our Socials</h2>
          <div className="flex items-center gap-4 justify-center">
            <a href="https://x.com/IThr3M" target="_blank" rel="noopener noreferrer">
              <div className="flex flex-col items-center justify-center p-1">
                <FontAwesomeIcon icon={faTwitter} className="text-i3m-pink" size="2x" />
                <h1 className="md:font-bold text-sm md:text-lg text-white">Twitter(X)</h1>
              </div>
            </a>
            <a href="" target="_blank" rel="noopener noreferrer">
              <div className="flex flex-col items-center justify-center p-1">
                <FontAwesomeIcon icon={faTelegram} className="text-i3m-pink" size="2x" />
                <h1 className="md:font-bold text-sm md:text-lg text-white">Telegram</h1>
              </div>
            </a>
            <a href="https://www.linkedin.com/company/i-three-m" target="_blank" rel="noopener noreferrer">
              <div className="flex flex-col items-center justify-center p-1">
                <FontAwesomeIcon icon={faLinkedin} className="text-i3m-pink" size="2x" />
        ...
        {/* Navigation Grid */}
        <div>
          <h2 className="text-2xl font-bold text-i3m-main mb-4">Quick Links</h2>
        ...
        <div>
          <h2 className="text-2xl font-bold text-i3m-main mb-4">Resources</h2>
          <ul className="space-y-2">
