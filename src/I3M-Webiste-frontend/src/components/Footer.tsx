  ...
  return (
    <footer className="relative h-auto flex flex-col items-center justify-center bg-i3m-dark text-center text-white px-4 py-10">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl w-full">
        {/* Socials Grid */}
        <div>
          <h2 className="text-2xl font-bold sm:text-4xl text-i3m-purple mb-4">
            Socials
          </h2>
          <div className="flex items-center gap-4 justify-center">
            ...
            >
              <div className="flex flex-col items-center justify-center p-1">
                ...
                <h1 className="md:font-bold text-sm md:text-lg text-white">
                  Twitter(X)
                </h1>
              </div>
            </a>
            ...
            >
              <div className="flex flex-col items-center justify-center p-1">
                <FontAwesomeIcon icon={faYoutube} className="text-white x" />
                <h1 className="md:font-bold text-sm md:text-lg text-white">
                  YouTube
                </h1>
              </div>
        ...
        {/* Navigation Grid */}
        <div>
          <h2 className="text-2xl font-bold text-i3m-purple mb-4">
            Quick Links
          </h2>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="/faq" className="hover:text-i3m-pink transition-colors">
                FAQs
              </a>
            </li>
          </ul>
